...
drag = $special.drag = {
	...
	init: function( event ){
		...
		$event.add( document, "mousemove mouseup mouseleave", drag.handler, dd );
	...
	handler: function( event ){ 
		...
		switch ( event.type ){
			...
			case !dd.dragging && 'mousemove': 
				//  drag tolerance, x占� + y占� = distance占�
			...
			case 'mouseup': 
				console.log('mouseup');
				$event.remove( document, "mousemove mouseup mouseleave", drag.handler ); // remove page events
				if ( dd.dragging ){
					if ( dd.drop !== false && $special.drop ) 
